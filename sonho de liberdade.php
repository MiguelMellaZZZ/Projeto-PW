...
<head>
    ...
    <title>BreakPlay | Um Sonho de Liberdade</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Filmes/UM SONHO DE LIBERDADE.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:40px">
        <h4  class="txtone">ASSISTIR UM SONHO DE LIBERDADE</h4>
        
        <h1 class="txttwo">UM SONHO DE LIBERDADE</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Diretores: </strong>Frank Darabont
            </h3>
            </div>
        <p style="color:white; display:flex; margin-left:15px; padding:20px;  text-align: justify;">
        Andy Dufresne é condenado a duas prisões 
        perpétuas consecutivas pelas mortes de sua esposa e de seu amante. Porém, só Andy 
        sabe que ele não cometeu os crimes. No presídio, durante dezenove anos, ele faz 
        amizade com Red, sofre as brutalidades da vida na cadeia, se adapta, ajuda os 
        carcereiros, etc.</p>
        </td>
        </tr>
        </div>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-180px; ">
                ...
                <p class="fixa">Ficção Policial</p>
                <p class="fixa">Assista em: Netflix</p>
            </div>   
            <iframe class="neat" width="765" height="470" src="https://www.youtube-nocookie.com/embed/v1nZq1vfgSw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
