...
<head>
    ...
    <title>BreakPlay | Dragon Ball Super</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Séries/Dragon Ball Super.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:10px">
        <h4  class="txtone">ASSISTIR A DRAGON BALL SUPER</h4>
        
        <h1 class="txttwo">DRAGON BALL SUPER</h1>
        <div class="dados">
        ...
        Dragon Ball Super segue as aventuras do protagonista 
        Goku e seus amigos, depois de derrotar Majin Buu e trazer paz para Terra mais uma vez. Goku 
        encontra seres de longe mais poderosos e atinge o poder de um deus.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-180px; ">
            ...
            <iframe class="neat" width="765" height="470" src="https://www.youtube.com/embed/JQtIATMIpu8" title="Dragon Ball Super" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
