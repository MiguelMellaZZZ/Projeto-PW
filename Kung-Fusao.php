...
<head>
    ...
    <title>BreakPlay | Kung-Fusão</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Filmes/KUNG-FUSÃO.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:40px">
        <h4  class="txtone">ASSISTIR A KUNG-FUSÃO</h4>
        
        <h1 class="txttwo">KUNG-FUSÃO</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Diretor: </strong>Stephen Chow
            </h3>
            </div>
        <p style="color:white; display:flex; margin-left:15px; padding:20px;  text-align: justify;">
        Ao tentarem enganar os residentes de Pig Sty Alley, 
        fingindo ser de uma gangue, o estranho Sing e seu amigo idiota Bones são surpreendidos pelos 
        verdadeiros bandidos. Ameaçados, são defendidos por um grande mestre em artes marciais.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-200px; ">
            ...
            <iframe class="neat" width="765" height="470"src="https://www.youtube.com/embed/FtE9-o6dBEI" title="Kung Fu Hustle | Official Trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
