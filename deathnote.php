...
<head>
    ...
    <title>BreakPlay | Death Note</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Séries/Death Note.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:40px">
        <h4  class="txtone">ASSISTIR A DEATH NOTE</h4>
        
        <h1 class="txttwo">DEATH NOTE</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Criadores: </strong>Tsugumi Ohba, Takeshi Obata
            </h3>
            </div>
        ...
        com poderes sobrenaturais, chamado Death Note, no qual era possível matar uma pessoa apenas 
        escrevendo seu nome no caderno. Quando o descobre, Light tenta eliminar todos os criminosos 
        do mundo e dar à sociedade um mundo livre do mal.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-180px; ">
            ...
            <iframe class="neat" width="765" height="470" src="https://www.youtube.com/embed/NlJZ-YgAt-c" title="Death Note | OFFICIAL TRAILER" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
