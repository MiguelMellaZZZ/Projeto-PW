...
<head>
    ...
    <title>BreakPlay | Jujutsu Kaisen</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Séries/Jujutsu Kaizen.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:10px">
        <h4  class="txtone">ASSISTIR A JUJUTSU KAISEN</h4>
        
        <h1 class="txttwo">JUJUTSU KAISEN</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Criador: </strong>Gege Akutami
            </h3>
            </div>
        <p style="color:white; display:flex; margin-left:15px; padding:20px;  text-align: justify;">
        Apesar do estudante colegial Yuuji Itadori ter 
        grande força física, ele se inscreve no Clube de Ocultismo. Certo dia, eles encontram um 
        “objeto amaldiçoado” e retiram o selo, atraindo criaturas chamadas de “maldições”.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-200px; ">
                ...
                <p class="fixa">Sombrio</p>
                <p class="fixa">Lutas</p>
                <p class="fixa">Assista em: Crunchyroll</p>
            </div>   
            <iframe class="neat"width="765" height="470" src="https://www.youtube.com/embed/ynr6gnyu9NE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
