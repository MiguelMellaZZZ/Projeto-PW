...
<head>
    ...
    <title>BreakPlay | The Karate Kid III</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Filmes/THE KARATE KID III.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:40px">
        <h4  class="txtone">ASSISTIR A THE KARATE KID III</h4>
        
        <h1 class="txttwo">THE KARATE KID III</h1>
        <div class="dados">
        ...
        O instrutor Cobra Kai de caratê John Kreese ainda 
        não superou a derrota para Daniel LaRusso e o Sr. Miyagi. Então, Kreese e Terry Prata armam 
        um plano para roubar de Daniel seu título de campeão, só que agora com Mike, um violento
        soldado do exército. Daniel terá um grande desafio pela frente já que o Sr. Miyagi recusa-se
        a prepará-lo para o confronto e, para piorar, ele comete o erro de procurar Terry para
        orientação.</p>
        </td>
        </tr>
        </div>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-200px; ">
            ...
            <iframe class="neat" width="765" height="470" src="https://www.youtube.com/embed/42xkTso8krA" title="The Karate Kid Part III (1989) Trailer #1 | Movieclips Classic Trailers" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
