...
<head>
    ...
    <title>BreakPlay | ORANGE IS THE NEW BLACK</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Séries/orange is the new black.png" alt="" width="280px"></td>
            </div>
        <td>
        <div>
        <h4  class="txtone">ASSISTIR A ORANGE IS THE NEW BLACK</h4>
        
        <h1 class="txttwo">ORANGE IS THE NEW BLACK</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Criadora: </strong>Jenji Kohan
            </h3>
            </div>
        <p style="color:white; display:flex; margin-left:15px; padding:20px;  text-align: justify;">
        Uma privilegiada garota de Nova York acaba na prisão por um crime cometido anos atrás.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-220px; ">
                ...
                <p class="fixa">Prisão</p>
                <p class="fixa">Assista em: Netflix</p>
            </div>   
            <iframe class="neat" width="765" height="470" width="560" height="315" src="https://www.youtube-nocookie.com/embed/Kg5aoek7dPQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
