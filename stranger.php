...
<head>
    ...
    <title>BreakPlay | Stranger Things</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Séries/stranger things .png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:10px">
        <h4  class="txtone">ASSISTIR A STRANGER THINGS</h4>
        
        <h1 class="txttwo">STRANGER THINGS</h1>
        <div class="dados">
        ...
        Um grupo de amigos se envolve em uma série de eventos sobrenaturais na pacata cidade 
        de Hawkins. Eles enfrentam criaturas monstruosas, agências secretas do governo e se 
        aventuram em dimensões paralelas.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-180px; ">
                ...
                <p class="fixa">Sobrenatural</p>
                <p class="fixa">Mistério</p>
                <p class="fixa">Assista em: Netflix</p>
            </div>   
            <iframe class="neat" width="765" height="470" src="https://www.youtube.com/embed/fLL0_Vy2Wlo" title="Stranger Things - Trailer 2 - Netflix [HD]" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
