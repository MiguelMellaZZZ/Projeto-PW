...
<head>
    ...
    <title>BreakPlay | As Branquelas</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Filmes/AS BRANQUELAS.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:40px">
        <h4  class="txtone">ASSISTIR AS BRANQUELAS</h4>
        
        <h1 class="txttwo">AS BRANQUELAS</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Diretor: </strong>Keenen Ivory Wayans
            </h3>
            </div>
        ...
        Copeland, acidentalmente evitam que bandidos sejam presos em uma apreensão de drogas. 
        Como castigo, eles são forçados a escoltar um par de socialites nos Hamptons. Porém, 
        quando as meninas descobrem o plano da agência, se recusam a ir. Sem opções, Marcus e 
        Kevin decidem posar como as irmãs, transformando-se de homens afro-americanos em um par 
        de loiras.</p>
        </td>
        </tr>
        </div>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-180px; ">
                ...
                <p class="fixa">Policial</p>
                <p class="fixa">Assista em: Netflix</p>
            </div>   
            <iframe class="neat"width="765" height="470" src="https://www.youtube.com/embed/seoJIPLLWp0" title="As Branquelas (Legendado)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
