...
<head>
    ...
    <title>BreakPlay | THE SANDMAN</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Séries/THE SANDMAN.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:40px">
        <h4  class="txtone">ASSISTIR A THE SANDMAN</h4>
        
        <h1 class="txttwo">THE SANDMAN</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Diretor: </strong>Shawn Levy
            </h3>
            </div>
        <p style="color:white; display:flex; margin-left:15px; padding:20px;  text-align: justify;">
        Sandman é o responsável pelo Mundo dos Sonhos, tendo 
        acesso aos sonhos de todas as criaturas que sejam capazes de sonhar. A história da série tem 
        início quando ele é preso em 1916, após se envolver em uma briga entre um mago e a Morte. 
        Morpheus só consegue fugir depois de 106 anos em cárcere.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-180px; ">
            ...
            <iframe class="neat" width="765" height="470" src="https://www.youtube-nocookie.com/embed/DDeSVVZ8h-Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
