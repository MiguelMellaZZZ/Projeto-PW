...
<head>
    ...
    <title>BreakPlay | Megamente</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Filmes/MEGAMENTE.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:50px">
        <h4  class="txtone">ASSISTIR A MEGAMENTE</h4>
        
        <h1 class="txttwo">MEGAMENTE</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Diretor: </strong>Tom McGrath
            </h3>
            </div>
        <p style="color:white; display:flex; margin-left:15px; padding:20px;  text-align: justify;">
        Embora seja o vilão mais brilhante que o mundo 
        já conheceu, Megamente é o menos bem-sucedido. Derrotado repetidamente pelo heroico Metro 
        Man, ele fica surpreso quando finalmente consegue derrotar o seu inimigo de longa data. 
        Porém, sem Metro Man, Megamente não tem nenhum propósito na vida, então ele cria um novo 
        adversário que logo decide que é mais divertido ser um vilão que um herói.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-200px; ">
            ...
            <iframe class="neat" width="765" height="470" width="560" height="315" src="https://www.youtube-nocookie.com/embed/GTgogZbAtu8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
