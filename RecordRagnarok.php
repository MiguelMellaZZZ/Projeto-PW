...
<head>
    ...
    <title>BreakPlay | Record of Ragnarok</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Séries/RECORD OF RAGNAROK.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:30px">
        <h4  class="txtone">ASSISTIR A RECORD OF RAGNAROK</h4>
        
        <h1 class="txttwo">RECORD OF RAGNAROK</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Criadores: </strong>AZYCHIKA, SHINYA UMEMURA, TAKUMI FUKUI
            </h3>
            </div>
        <p style="color:white; display:flex; margin-left:15px; padding:20px;  text-align: justify;">
        Record of Ragnarok, ou Shuumatsu no Valkyrie, conta 
        a história do que seria o fim da humanidade. Assim, neste universo, os deuses das mais diversas
         religiões existem em conjunto e a cada mil anos, decidem se a humanidade será extinta ou não.
          Na atual reunião, é optado pela extinção total da raça humana.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-200px; ">
                ...
                <p class="fixa">Ficção Cientifica</p>
                <p class="fixa">Fantasia</p>
                <p class="fixa">Assista em: Netflix</p>
            </div>   
                <iframe class="neat"width="765" height="470"src="https://www.youtube.com/embed/7yowPv9_5xQ" title="Record of Ragnarok II | Teaser oficial | Netflix" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
    <br><br>
</body>
</html>
