...
<head>
    ...
    <title>BreakPlay | A Procura da Felicidade</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Filmes/A PROCURA DA FELICIDADE.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:40px">
        <h4  class="txtone">ASSISTIR A PROCURA DA FELICIDADE</h4>
        
        <h1 class="txttwo">A PROCURA DA FELICIDADE</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Diretor: </strong>Gabriele Muccino
            </h3>
            </div>
        <p style="color:white; display:flex; margin-left:15px; padding:20px;  text-align: justify;">
        Chris enfrenta sérios problemas financeiros e 
        Linda, sua esposa, decide partir. Ele agora é pai solteiro e precisa cuidar de Christopher, 
        seu filho de 5 anos. Chris tenta usar sua habilidade como vendedor para conseguir um emprego 
        melhor, mas só consegue um estágio não remunerado. Seus problemas financeiros não podem esperar 
        uma promoção e eles acabam despejados. Chris e Christopher passam a dormir em abrigos ou onde 
        quer que consigam um refúgio, mantendo a esperança de que dias melhores virão.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-180px; ">
                ...
                <p class="fixa">Biografia</p>
                <p class="fixa">Drama</p>
                <p class="fixa">Assista em: Netflix</p>
            </div>   
            <iframe class="neat"width="765" height="470" src="https://www.youtube-nocookie.com/embed/7guyl6_7sBo?start=4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
