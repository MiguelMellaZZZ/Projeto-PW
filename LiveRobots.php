...
<head>
    ...
    <title>BreakPlay | LOVE DEATH + ROBOTS</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Séries/love death robots.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:80px">
        <h4  class="txtone">ASSISTIR A LOVE DEATH + ROBOTS</h4>
        
        <h1 class="txttwo">LOVE DEATH + ROBOTS</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Criadores: </strong>Tim Miller, David Fincher
            </h3>
            </div>
        <p style="color:white; display:flex; margin-left:15px; padding:20px;  text-align: justify;">
        Love Death and Robots é uma série de antologia em 
        animação da Netflix destinada ao público adulto, com apresentação de Tim Miller e David 
        Fincher. A coleção de histórias cobre uma variedade de tópicos para adultos, incluindo 
        racismo, governo, guerra, livre arbítrio e natureza humana. A coleção antológica abrange 
        os gêneros de ficção científica, fantasia, horror e comédia, e cada curta possui um estilo
         de animação único: do tradicional 2D ao photo-real 3D CGI.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-170px; ">
                ...
                <p class="fixa">Classificação 19</p>
                <p class="fixa">Suspense</p>
                <p class="fixa">Assista em: Netflix</p>
            </div>   
            <iframe class="neat" width="765" height="470" src="https://www.youtube-nocookie.com/embed/uD-242dcxRE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
