...
<head>
    ...
    <title>BreakPlay | Por Água Abaixo</title>
    <style type="text/css">
        .neat {
        display: none;
        clear: both;
...
<nav class="navbar bg-dark navbar-gradient">   
    ...
    <div class="container" >    
        ...
        <tr>
            <div>
                <td><img class="banner" src="img/Filmes/POR AGUA ABAIXO.png" alt="" width="280px"></td>
            </div>
        <td>
        <div style="margin-top:50px">
        <h4  class="txtone">ASSISTIR A POR ÁGUA ABAIXO</h4>
        
        <h1 class="txttwo">POR ÁGUA ABAIXO</h1>
        <div class="dados">
            ...
            <h3 style="font-size:16px">
                <strong>Diretor: </strong>Sam Fell, David Bowers
            </h3>
            </div>
        <p style="color:white; display:flex; margin-left:15px; padding:20px;  text-align: justify;">
        Roddy é um ratinho acostumado a um bairro luxuoso 
        de Londres. Sem querer, ele dá uma descarga infeliz e acaba nos esgotos, onde terá de 
        aprender a viver de uma forma completamente diferente.</p>
        </td>
        </tr>
        </div>
        <td>
        ...
        <div style="color:white;display:flex; margin-left:308px; padding:10px; margin-top:-200px; ">
                ...
                <p class="fixa">Assista em: Apple TV</p>
            </div>   
            <iframe class="neat" width="765" height="470" width="560" height="315" src="https://www.youtube.com/embed/g4tJTMWfa8Y"  title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
